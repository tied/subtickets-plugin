...
public class Constants {
    ...
    public static final String ESTEBLISHED_FUND_TYPE_VALUE = "Esteblished";
    public static final String CUSTOM_FUND_TYPE_VALUE = "Custom";

    public static final String AUTO_COMPONENT_NAME = "Auto";
    public static final String DOOR_COMPONENT_NAME = "Door";
